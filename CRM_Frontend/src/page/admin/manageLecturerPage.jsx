...
export default memo( function ManageLecturerPage ()
{
	...
	{
		const response = await API_SERVICE.post( "user/lecturer", data );
		return response;
	};

	const deleteLecturer = async ( id ) =>
	{
		const response = await API_SERVICE.delete( "user/lecturer/" + id );
		return response;
	};
							...
							<tbody>
								{ lecturers.map( ( lecturer, index ) => (
									...
									>
										...
										<td className="border px-4 py-2">{ lecturer.name || lecturer.fullName }</td>
										...
										<td className="border px-4 py-2 flex justify-around items-center">
											<TbUserEdit
												...
												onClick={ ( e ) => handleModifyLecturer( e, lecturer.lecturerId ) }
												size={ 40 }
											/>
											<AiOutlineUserDelete
												...
												onClick={ ( e ) => handleDeleteLecturer( e, lecturer.lecturerId ) }
												size={ 40 }
											/>
										</td>
									</tr>
